 ...
 * @author secretaria
 */
public class ReportBeneficiaryPendingController {
    ...
    Document generateData(Document document) {
        ...
        try {
            ...
            data = funprefController.getJdbcController().getReportBeneficiaryPendingData();
            ...
            Logger.getLogger(ReportBeneficiaryPendingController.class.getName()).log(Level.SEVERE, null, ex);
        }
